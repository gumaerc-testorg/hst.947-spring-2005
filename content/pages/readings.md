...
HST.947 students are expected to complete all readings for 6.034. The Chapter readings assigned for lecture sessions (L) come from the course [lecture notes]({{< baseurl >}}/pages/lecture-notes). Additonal readings are assigned for the weekly discussion sessions (D) as listed in the table.
